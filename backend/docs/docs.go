...
const docTemplate = `{
    ...
    "paths": {
        "/fifa/simulate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Home/away team ids, optional seed, extra_time flag",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.FIFASimulateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.FIFASimulateResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.FIFAListTeamsResponse"
                        }
                    }
                }
            }
        ...
        "/nba/simulate/draft-lottery": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "14 team IDs in lottery-seed order (index 0 = worst record)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.SimulateDraftLotteryRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.SimulateDraftLotteryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "internal_api.ConferenceCup": {
            "type": "object",
            "properties": {
                "qf": {
                    "description": "QF[0]=1v4, QF[1]=2v3",
                    "type": "array",
                    "items": {
                ...
                "seeds": {
                    "description": "index 0 = seed 1, index 3 = wildcard",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "internal_api.CupBracket": {
            "type": "object",
            "properties": {
                "east": {
                    "$ref": "#/definitions/internal_api.ConferenceCup"
                },
                "final": {
                    "$ref": "#/definitions/internal_api.CupGame"
                },
        ...
        "internal_api.FIFAListTeamsResponse": {
            ...
            "properties": {
                "teams": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.FIFATeamOption"
                    }
                }
            }
        },
        "internal_api.FIFAPenaltyKick": {
            "type": "object",
            "properties": {
                "kick_no": {
                    "type": "integer"
        ...
        "internal_api.FIFAPenaltyResult": {
            "type": "object",
            "properties": {
                "kicks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.FIFAPenaltyKick"
                    }
                },
                "team1_scored": {
                    "type": "integer"
        ...
        "internal_api.FIFASimulateRequest": {
            "type": "object",
            "properties": {
                "extra_time": {
                    "type": "boolean",
                ...
                "host_team_id": {
                    "description": "optional: team receiving +100 Elo crowd boost",
                    "type": "string",
                    "example": "USA"
                },
                "seed": {
        ...
        "internal_api.FIFASimulateResponse": {
            "type": "object",
            "properties": {
                "penalties": {
                    "$ref": "#/definitions/internal_api.FIFAPenaltyResult"
                },
                "period": {
                    "description": "\"90\" | \"aet\" | \"pens\"",
                    "type": "string"
                },
                "seed": {
                    "type": "integer"
                ...
                "winner": {
                    "description": "empty = draw (group stage)",
                    "type": "string"
                }
            }
        },
        "internal_api.FIFATeamOption": {
            "type": "object",
            "properties": {
                "elo": {
                    "type": "integer"
        ...
        "internal_api.SimulateDraftLotteryResponse": {
            "type": "object",
            "properties": {
                "picks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.DraftPick"
                    }
                },
                "seed": {
                    "type": "integer",
